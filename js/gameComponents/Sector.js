...
const mapStateToProps = stores => ({
    ...
    actualBonus: stores.gameStore.actualBonus,
});

const Sector = ({ order, name, answerData, isAnswered, actualCode, actualBonus }) => (
    <View
        style={[
            styles.mainContainer,
            { backgroundColor:
                (isAnswered && Helper.isEqualCode(answerData.Answer, actualCode))
                    ? Colors.blue
                    : Colors.background,
            },
        ]}
